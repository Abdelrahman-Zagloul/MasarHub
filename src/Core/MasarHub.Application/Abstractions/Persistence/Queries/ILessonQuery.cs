...
namespace MasarHub.Application.Abstractions.Persistence.Queries
{
    public interface ILessonQuery : IScopedService
    {
        ...
        Task<ModuleAccessData> GetModuleAccessDataAsync(Guid moduleId, Guid instructorId, CancellationToken ct = default);
    ...
    public sealed record ModuleAccessData(bool ModuleExist, bool IsOwner);
