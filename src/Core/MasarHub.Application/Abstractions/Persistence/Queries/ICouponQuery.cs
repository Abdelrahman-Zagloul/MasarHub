...
namespace MasarHub.Application.Abstractions.Persistence.Queries
{
    public interface ICouponQuery : IScopedService
    {
        ...
        Task<CouponDetails> GetByIdAsync(Guid couponId, Guid courseId, Guid userId, CancellationToken ct = default);
    }
    ...
    public sealed record CouponDetails(CouponResponse? Coupon, bool IsOwner);
}
