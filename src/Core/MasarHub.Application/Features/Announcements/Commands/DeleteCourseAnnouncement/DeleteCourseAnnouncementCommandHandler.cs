...
{
    public sealed class DeleteCourseAnnouncementCommandHandler : IRequestHandler<DeleteCourseAnnouncementCommand, Result>
    {
        private readonly ICourseQuery _courseQuery;
        private readonly IRepository<CourseAnnouncement> _announcementRepository;
        private readonly IUnitOfWork _unitOfWork;

        public DeleteCourseAnnouncementCommandHandler(ICourseQuery courseQuery, IRepository<CourseAnnouncement> announcementRepository, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Result> Handle(DeleteCourseAnnouncementCommand request, CancellationToken cancellationToken)
        {
