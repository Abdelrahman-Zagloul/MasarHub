...
{
    public sealed class DisableLessonPreviewCommandHandler : IRequestHandler<DisableLessonPreviewCommand, Result>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ILessonQuery _lessonQuery;
        private readonly IRepository<Lesson> _lessonRepository;

        public DisableLessonPreviewCommandHandler(IUnitOfWork unitOfWork, ILessonQuery lessonQuery, IRepository<Lesson> lessonRepository)
        {
        ...
        public async Task<Result> Handle(DisableLessonPreviewCommand request, CancellationToken cancellationToken)
        {
