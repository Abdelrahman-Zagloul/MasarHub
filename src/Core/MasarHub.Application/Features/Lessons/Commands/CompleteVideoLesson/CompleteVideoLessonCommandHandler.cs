...
{
    public sealed class CompleteVideoLessonCommandHandler : IRequestHandler<CompleteVideoLessonCommand, Result<CompleteVideoLessonResponse>>
    {
        ...
        public CompleteVideoLessonCommandHandler(IUnitOfWork unitOfWork, IRepository<Lesson> lessonRepository, ILessonQuery lessonQuery, IFileStorageService fileStorageService)
        {
        ...
        public async Task<Result<CompleteVideoLessonResponse>> Handle(CompleteVideoLessonCommand request, CancellationToken cancellationToken)
        {
            ...
            return new CompleteVideoLessonResponse(
