...
{
    public sealed class PublishCourseAnnouncementCommandHandler : IRequestHandler<PublishCourseAnnouncementCommand, Result>
    {
        private readonly ICourseQuery _courseQuery;
        private readonly IRepository<CourseAnnouncement> _announcementRepository;
        private readonly IUnitOfWork _unitOfWork;

        public PublishCourseAnnouncementCommandHandler(ICourseQuery courseQuery, IRepository<CourseAnnouncement> announcementRepository, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Result> Handle(PublishCourseAnnouncementCommand request, CancellationToken cancellationToken)
        {
